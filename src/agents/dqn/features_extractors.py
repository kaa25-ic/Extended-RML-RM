"""Feature extractors for LetterEnv DQN experiments."""
...
class LetterEnvVectorExtractor(BaseFeaturesExtractor):
    """Feature extractor for one-hot and numerical monitor encodings."""
...
class LetterEnvSimpleEmbeddingExtractor(BaseFeaturesExtractor):
    """Feature extractor for the simple integer monitor encoding."""
    ...
    def __init__(
        ...
        *,
        ...
        position_dim = _flat_dim(observation_space["position"])
        self.max_monitor_states = max_monitor_states
        ...
        self.monitor_embedding = nn.Embedding(max_monitor_states, monitor_embedding_dim)
        self.fusion_net = nn.Sequential(

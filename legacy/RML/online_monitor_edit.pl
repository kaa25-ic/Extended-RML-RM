        ...
        (   next(TE1, E, TE2) ->
            ...
            (   TE2 = 1 ->
                ...
                (may_halt(TE2) ->
                    ...
                    (writeln('verdict = ?_False'), Reply = _{}.put(E).put(_{verdict:currently_false, monitor_state:Code})))) % Verdict = ?_False
            ;   (writeln('verdict = False'), initialize_monitor, term_string(TE1, TE1Str), Reply = _{}.put(E).put(_{verdict:false, monitor_state:'false_verdict', spec:TE1Str}))), % Verdict = False
